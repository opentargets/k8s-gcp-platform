locals {
  ...
  platform_images_most_recent_ch = length(local.platform_images_list_ch) == 0 ? "" : element(local.platform_images_list_ch, length(local.platform_images_list_ch) - 1)
  ...
  platform_images_most_recent_os = length(local.platform_images_list_os) == 0 ? "" : element(local.platform_images_list_os, length(local.platform_images_list_os) - 1)
  ...
  ppp_images_most_recent_ch = length(local.ppp_images_list_ch) == 0 ? "" : element(local.ppp_images_list_ch, length(local.ppp_images_list_ch) - 1)
  ...
  ppp_images_most_recent_os = length(local.ppp_images_list_os) == 0 ? "" : element(local.ppp_images_list_os, length(local.ppp_images_list_os) - 1)
}